 ...
 */
Ext.define('Haamro.custom.LocalStorage', {
    extend: 'Ext.data.proxy.WebStorage',
    alias: 'proxy.customLocalstorage',
    alternateClassName: 'CustomLocalStorageProxy',
    ...
    clear: function() {
        ...
        // housekeeping code to remove additional left over stored items
    	// TBD - there might be a bug in JsonCacheUtil leading to items being left over but housekeeping is good anyways
        var obj = this.getStorageObject(),
        	index = 0,
    		re = new RegExp(this.getId() + '.*');
