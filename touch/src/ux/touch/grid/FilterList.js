Ext.define('Ext.ux.touch.grid.FilterList', {
    extend   : 'Ext.ux.touch.grid.List',
    xtype    : 'touchfiltergrid',
    ...
    constructor: function(config) {
        ...
        console.log(element);*/
		console.log(config.showFilterRow);
		console.log(this.showFilterRow);
        if(config.showFilterRow==true){
			console.log('Showing Filter Row');
            filterRowToolbar= Ext.create('Ext.Toolbar',{
                scope:this,
                xtype:'filtergridtoolbar',
                docked : 'top',
                layout : {
                    type : 'hbox',
                }
        ...
        for (c=0; c < filterRowCell.length; c++) {
            ...
            if(elem.getAttribute('hidden')!="true"&&elem.getAttribute('gridid')==this.getId()){ 
                ...
                if(this.showFilterRowPaging&&c==0){
					console.log('In Show Filter Row Paging');
